    ...
    <section className="relative text-gray-600 py-5 body-font">
        ...
        <div className="container px-5 mx-auto">
            ...
            <div className="flex justify-center">
                ...
                </svg> <span className="absolute text-white bg-red-400 -right-4 -top-4 rounded-full w-8 h-8 text-sm p-1">{up_votes.length}</span></button> 
                ...
                </svg> <span className="absolute text-white bg-red-400 -right-4 -top-4 rounded-full w-8 h-8 text-sm p-1">{down_votes.length}</span></button>
            </div>
        </div>
    </section>
  )
