...
export default function SignInbtn() {
    ...
    return (
        <button onClick={logout} className="inline-flex items-center bg-gray-200 border-0 py-1 px-3 focus:outline-none hover:bg-gray-300 rounded text-base mt-4 md:mt-0">Logout</button>
    )
}